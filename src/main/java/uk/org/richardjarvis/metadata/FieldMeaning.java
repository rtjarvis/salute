...
public class FieldMeaning {
    ...
    public enum MeaningType {PHONE_NUMBER, MAC_ADDRESS, IPv4, IPv6, EMAIL_ADDRESS, URL, UNKNOWN, GEOHASH, AUDIO_WAVEFORM, NUMERIC, TEXT, DATE, DATE_PART, ORGANISATION, LOCATION, MONEY, NAME, BOOLEAN, ONE_HOT}
